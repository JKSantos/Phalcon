    ...
    <body data-ng-app="noobsApp">
         <div class = "modal-content" style = "height: 350px; width: 500px; margin-left: 700px; margin-top: 250px;">
			...
			<div class = "modal-body">
				...
				<form class="form-horizontal data-noobs-directive" role="form">
				    <div class="form-group">
                        <label style = "margin-left: 50px;">Please sign-in using your username and password.</label><br><br>
                        <label class="control-label col-sm-2">Username:</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name= "tfUsername" value="123456879" placeholder="Enter Username" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-sm-2">Password:</label>
                        <div class="col-sm-10"> 
                            <input type="password" class="form-control" value="123456879"  name= "tfPassword" placeholder="Enter password" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group"> 
                        ...
                        <div style= "margin-top:20px;" class=" col-sm-10">
                            <button class="btn btn-primary data-noobs-directive"  name= "btnLogin">Login</button>
